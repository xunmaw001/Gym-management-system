    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="预约备注" prop="jiaolianYuyueText">
                        <el-input type="textarea"  :readonly="ro.jiaolianYuyueText" v-model="ruleForm.jiaolianYuyueText" placeholder="预约备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiaolianYuyueText" label="预约备注" prop="jiaolianYuyueText">
